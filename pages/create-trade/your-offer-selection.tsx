    ...
    {showAddNftsModal ? <AddNfts closeModal={closeModal} /> : ''}
      ...
      <div className="lg:ml-72 flex flex-col items-center justify-center">
        ...
        <div className="bg-slate-700 text-center lg:w-2/3 rounded-lg p-12 space-y-6">
          <h1 className="text-2xl text-orange-400">What I Offer</h1>
          <p>
            Select NFTs and SOLyou offer. Your offered NFts and Tokens will go
            into escrow until the counterparty accepts. You can cancle and
            withdraw your offer any time from{" "}
            <Link
              href="trades/send-offers"
        ...
        <div className="my-12 space-x-6 flex items-center p-3 justify-center text-sm w-full">
          ...
          <Link
            href="/create-trade/confirmation"
