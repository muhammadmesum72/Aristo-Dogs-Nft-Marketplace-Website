        ...
        <div className='lg:w-4/12 w-full text-center lg:text-left mb-3'>
          ...
          <div className='w-11/12'>
            ...
            <div className='space-y-3'>
              ...
              <p>Well, let me tell you that we have you covered…  <a href="https://aristodogs.medium.com/chapter-1-the-hosting-raffle-1693669ec657"  className='text-secondary font-bold'>Find out more here</a></p>
            </div>
          </div>
        </div>
        {/* stage 2 */}
        ...
        <div className='lg:w-4/12 w-full text-center lg:text-left mb-3'>
          ...
          <div className='w-11/12'>
            ...
            <div className='space-y-3'>
              ...
              <p>Join our <a href="https://aristodogs.medium.com/chapter-1-the-hosting-raffle-1693669ec657"  className='text-secondary font-bold'>Discord</a> and keep tuned for more…</p>
            </div>
          </div>
        </div>
        {/* stage 3 */}
        ...
        <div className='lg:w-4/12 w-full text-center lg:text-left mb-3'>
          ...
          <div className='w-11/12'>
            ...
            <div className='space-y-3'>
              ...
              <p><a href="https://aristodogs.medium.com/chapter-3-the-dog-house-d0759329956f"  className='text-secondary font-bold'>Find out what house suits you better</a></p>
            </div>
          </div>
        </div>
        {/* stage 6 */}
