...
const LoanListing = () => {
  ...
  return (
    <div className="lg:px-9 p-6 border-t-1 border-opacity-20 border-blue-400">
      <div>
        <button
              ...
              <div className="rounded-xl bg-slate-900 text-white p-2 flex flex-col items-start justify-center mr-2 mt-2">
                ...
                <div className="space-y-1 py-3 text-sm w-full">
                    ...
                    <div className="mx-auto text-center py-3">
                      <Link href='/loan/create-loan-listing'>
                    <button className="bg-hardSecondary text-white font-bold p-3 rounded-xl w-fit">List For Loan</button>
                      </Link>
                    </div>
                </div>
              </div>
