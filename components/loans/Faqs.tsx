              ...
              <div className="my-3">
                <div>
                  ...
                  >
                    ...
                    {showFaq ? (
                      <AiFillDownSquare className="w-9 mr-3 transition-all duration-200  " />
                    ) : (
                      <AiFillDownSquare className="w-9 mr-3 transition-all duration-200 rotate-180  " />
                    )}
                  </button>
                </div>
                {showFaq ? (
                    ...
                    <div className="flex justify-start flex-wrap gap-y-3 p-4">
                      <span className="opacity-80">
                        <span>
                          ...
                          and the listing termsprice, optional creator fees,
                          optional charity/DAO fees. After confirming, the NFT
                          is moved to an escrow wallet. When somebody chooses to
                          buy it, the NFT is moved to their wallet, while the
                          amount paid is sent to the seller with any relevant
                          fees deducted.
                        </span>
                      </span>
                    </div>
